...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-4 col-sm-6 text-center">
			...
			<h4 class="text2"><b>Barang 100% Baru dan Original</b></h4>
		...
		<div class="col-lg-4 col-sm-6 text-center">
			...
			<h4 class="text2"><b>Ongkos Kirim Murah dan Cepat</b></h4>
			<p>Praesent rutrum vitae ligula sit amet vehicula. Donec eget libero nec dolor tincidunt vulputate.</p>
		</div>
		...
		<div class="col-lg-4 col-sm-6 text-center">
			...
			<h4 class="text2"><b>Perlindungan Barang dan Garansi Original</b></h4>
			<p>Praesent rutrum vitae ligula sit amet vehicula. Donec eget libero nec dolor tincidunt vulputate.</p>
		</div>
	</div>
</div>
...
<div class="top-products">
	<div class="container">
		...
		<div class="row product">
				...
				$query = "SELECT * FROM product WHERE available = 'Ada' ORDER by item_id ASC LIMIT $num, $perpage";
			...
			<div class="carousel carousel-show slide" id="myCarousel">
				...
				while($row = mysqli_fetch_array($query)){
					if($i == 1) {
						...
						echo '<div class="col-md-2 col-sm-6 col-xs-12"><span><img src="../logo/'.$row['logo'].'" class="img-responsive"></span></div>';
					}
					$i = 0;
					echo '</div>';
					$i++;
