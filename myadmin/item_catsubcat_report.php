...
<head>
	...
	<title>Handal Yesindo Sejahtera | Laporan Data Produk Berdasarkan Kategori dan Subkategori</title>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal">
							<legend>Laporan Data Produk Berdasarkan Kategori</legend>
							<p>Pencarian data produk menurut kategori</p>
				...
				<?php
					...
					$sql1 = "SELECT * FROM items INNER JOIN brands ON brands.brd_id = items.brd_id INNER JOIN categories ON 
							  categories.cat_id = items.cat_id ORDER BY creation_date ASC LIMIT $num, $perpage";
