...
<head>
	...
	<title>Handal Yesindo Sejahtera | Laporan Data Produk</title>
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				...
				<?php
					...
					$sql1 = "SELECT * FROM items INNER JOIN brands ON brands.brd_id = items.brd_id INNER JOIN categories ON categories.cat_id = items.cat_id ORDER BY creation_date ASC LIMIT $num, $perpage";
