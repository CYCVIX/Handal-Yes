<div class="container">
	<div class="row">
		...
		<?php
		$query = mysqli_query($conn, "SELECT * FROM members INNER JOIN orders ON members.fullname = orders.owner_name WHERE member_id = '".$member."'");
		...
		if(isset($_POST['checkout'])){
			if($_SERVER['REQUEST_METHOD'] == "POST"){
				...
				if(!$error){
					...
					$result = mysqli_query($conn,"INSERT INTO orders VALUES('".$id."','".$member."','".$owner."','".$cardbank."','".$cardnumber."','PAID','".$pay."','".$nResi."','".$regdate."','".$regtime."','PENDING','".$regdate."','".$regtime."')");
					if(!$result){
